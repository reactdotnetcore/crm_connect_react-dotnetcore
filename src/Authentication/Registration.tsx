...
// import './assets/css/style.css'; // Adjust the path as per your folder structure

function Register() {
  return (
    <main>
      <div className="container">
        <section className="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-1">
          <div className="container">
